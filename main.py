...
def get_state(state):
    ...
    return_state['dist_to_pipe_top'] = state["next_pipe_bottom_y"] - state["player_y"]
...
if __name__ == "__main__":
            ...
            for die in range(100):
                ...
                while True:
                    ...
                    if p.game_over():
                        ...
                        print(f"This is the {round} round the {times} trails")
    ...
    save.to_csv('save/result2_2.csv', index = False)
