...
def get_state(state):
    return_state = dict()
    return_state['dist_to_pipe_top'] = state["player_y"] - state["next_pipe_top_y"]
    return_state['dist_to_pipe_bottom'] = state["next_pipe_bottom_y"] - state["player_y"]  
    return_state['dist_to_pipe_horz'] = state["next_pipe_dist_to_player"]
    return_state['velocity '] = state['player_vel']
    #print(return_state)
    #return_state['next_dist_to_pipe_bottom'] = state["player_y"] - state["next_next_pipe_top_y"]
    #return_state['next_dist_to_pipe_horz'] = state["next_next_pipe_dist_to_player"]
